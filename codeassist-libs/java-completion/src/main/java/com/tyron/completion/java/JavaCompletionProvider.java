...
public class JavaCompletionProvider extends CompletionProvider {
    ...
    static {
        ...
        try {
            ...
            f = completionThreadClass.getDeclaredField("mAborted");
            f.setAccessible(true);
        } catch (Throwable e) {
            Log.w("JavaCompletionProvider", "Rosemoe thread implementation has changed, cancellation might not work: " + e.getMessage());
        }
        sCanceledField = f;
    }
        ...
        try {
            ProgressIndicator indicator
                ...
                public void checkCanceled() {
                    ...
                    if (sCanceledField != null && Thread.currentThread().getClass().getName().equals(COMPLETION_THREAD_CLASS)) {
                        try {
